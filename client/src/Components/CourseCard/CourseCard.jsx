...
function CourseCard({data}) {
    ...
    return (
        <div
            onClick={() => navigate("/course/descriptions", { state: {...data}})}
            className="text-white w-[22rem] h-[430px] shadow-lg rounded-lg cursor-pointer group overflow-hidden bg-zinc-800"
        >
